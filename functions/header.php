...
<meta property="og:image" content="<?php echo $info['URL']; ?>/img/go1.to.jpg">
...
<link rel="icon" type="image/x-icon" href="<?php echo $info['URL']; ?>/go1-favicon.ico">
<style>
